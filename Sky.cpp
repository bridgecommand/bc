...
Sky::Sky(irr::scene::ISceneManager* smgr)
{
    ...
    skyNode=smgr->addSkyDomeSceneNode(driver->getTexture("media/sky.bmp"),16,8,0.95f,2.0f,3.5*M_IN_NM); //Fixme: Range should probably be dependent on fog & camera range.
