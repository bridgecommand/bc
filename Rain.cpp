...
void Rain::load(irr::scene::ISceneManager* smgr, irr::scene::ISceneNode* parent)
{
    ...
    rainIntensity = 0;
        ...
        if (rainTextures.size()==11) {
            rainNode1->setMaterialTexture(0,rainTextures.at(rainIntensity));
            rainNode2->setMaterialTexture(0,rainTextures.at(rainIntensity));
...
void Rain::setIntensity(u8 intensity) {

    if (intensity != rainIntensity && intensity < 11) {
