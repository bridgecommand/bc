;setup names
!define PROGRAMNAME "Bridge Command 5.11"
!ifndef OUTPUTFILE
!define OUTPUTFILE "..\BridgeCommand5.11.0-alpha.3.exe"
!endif
!define INSTALLLOCATION "Bridge Command 5.11"
!define SMFOLDER "Bridge Command 5.11"
!define REGKEY "BridgeCommand5.11"
...
SetShellVarContext all
  ...
  Delete "$INSTDIR\language-es.txt"
  Delete "$INSTDIR\languageController-es.txt"
  Delete "$INSTDIR\languageRepeater-es.txt"
  Delete "$INSTDIR\languageLauncher-es.txt"
  Delete "$INSTDIR\languageIniEditor-es.txt"
  Delete "$INSTDIR\languageMultiplayer-es.txt"
