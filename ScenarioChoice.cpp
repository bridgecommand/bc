...
std::string ScenarioChoice::chooseScenario()
{
    ...
    gui::IGUIListBox* scenarioListBox = gui->addListBox(core::rect<s32>(10,10,110,210),0,LISTBOXID);
    gui::IGUIButton* okButton = gui->addButton(core::rect<s32>(10,220,110,240),0,OKBUTTONID,L"OK"); //i18n?
