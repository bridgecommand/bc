...
bool EventReceiver::OnEvent(const irr::SEvent& event)
{
    if (event.EventType == irr::EET_GUI_EVENT) {
        ...
        if ((event.GUIEvent.EventType==irr::gui::EGET_BUTTON_CLICKED && (id == GUIMain::GUI_ID_APPLY_BUTTON || id == GUIMain::GUI_ID_SAVE_BUTTON)) ||
            (event.GUIEvent.EventType==irr::gui::EGET_EDITBOX_CHANGED && id == GUIMain::GUI_ID_SCENARIONAME_EDITBOX)) {
