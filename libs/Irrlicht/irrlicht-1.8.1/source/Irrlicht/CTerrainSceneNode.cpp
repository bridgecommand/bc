			...
			s32 smoothFactor)
	{
		...
		for (s32 x = 0; x < TerrainData.Size; ++x)
		{
			...
			for (s32 z = 0; z < TerrainData.Size; ++z)
			{
				...
				vertex.Pos.X = fx;
				//vertex.Pos.Y = (f32) heightMap->getPixel(TerrainData.Size-x-1,z).getLightness(); //JAMES: Replaced
				...
				//vertex.TCoords.X = vertex.TCoords2.X = 1.f-fx2; //JAMES: Replaced
				//vertex.TCoords.Y = vertex.TCoords2.Y = fz2; //JAMES: Replaced
