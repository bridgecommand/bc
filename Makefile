...
ifeq ($(UNAME_S),Darwin)
USERLDFLAGS = -stdlib=libc++ -L./libs/Irrlicht/irrlicht-1.8.1/source/Irrlicht/MacOSX/build/Release -lIrrlicht -L/usr/X11R6/lib$(LIBSELECT) -framework OpenGL -framework Cocoa -framework IOKit -framework CoreVideo
else
