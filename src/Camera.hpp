...
class Camera
{
    public:
        ...
        void update(irr::f32 deltaTime=0,  bool leftView=false, irr::core::quaternion quat=irr::core::quaternion(0,0,0,1), irr::core::vector2df lensShift=irr::core::vector2df(0,0));
