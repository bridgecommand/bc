...
public:
    ...
    SimulationModel(irr::IrrlichtDevice* dev, irr::scene::ISceneManager* scene, GUIMain* gui, std::string scenarioPath, bool secondary, irr::f32 viewAngle, irr::f32 lookAngle);
    ~SimulationModel();
