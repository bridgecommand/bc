...
void Water::load(irr::scene::ISceneManager* smgr, irr::f32 weather, irr::u32 disableShaders, irr::u32 segments)
{
    ...
    waterNode = new irr::scene::MovingWaterSceneNode(smgr->getRootSceneNode(),smgr,0,disableShaders,segments);
